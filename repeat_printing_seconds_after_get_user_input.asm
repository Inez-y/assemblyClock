...
msg3        db      'Seconds since Jan 01 1970: ', 0h     ; Define the message string

section .bss
sinput:     resb    255                                 ; reserve a 255 byte space in memory for the users input string
currentTime resd    1                                   ; 現在時刻を格納する変数
myTimeval   resb    16                                  ; `timeval` 構造体用のメモリを予約
...
loop_start:
    ...
    mov     eax, msg3        ; Move the address of the message string into eax for printing
